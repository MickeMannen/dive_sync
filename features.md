...
| 4.5 | Credentials form: save + test Garmin/Divelogs login | 🚧 | `POST /api/credentials` writes a single account and overwrites any multi-account list; it now keeps the Subsurface/Submersion sections, and the status/test endpoints cover them (no form fields yet, rework.md F13) |
